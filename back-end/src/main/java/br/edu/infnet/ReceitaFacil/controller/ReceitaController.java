...
public class ReceitaController {
    ...
    @PutMapping("/atualizareceita")
    void atualizaReceita(@RequestBody Receita receita) throws InterruptedException, ExecutionException {
        receitaService.updateReceita(receita);
    }
